CREATE TABLE IF NOT EXISTS users (
  ...
  balance_corriente INTEGER NOT NULL DEFAULT 0 CHECK (balance_corriente >= 0),
  balance_ahorro INTEGER NOT NULL DEFAULT 0 CHECK (balance_ahorro >= 0),
  last_ahorro_calc_date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
